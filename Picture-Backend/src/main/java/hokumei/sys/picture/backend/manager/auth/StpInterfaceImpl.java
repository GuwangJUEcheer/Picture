...
import hokumei.sys.picture.backend.manager.auth.model.SpaceUserAuthContext;
...
import static hokumei.sys.picture.backend.constant.UserConstant.USER_LOGIN_STATE;
